...
if ( !class_exists( 'Zz_acf_field_Leaflet' ) && class_exists( 'acf_field' ) ) {
    ...
    class Zz_acf_field_Leaflet extends acf_field
    {
        ...
        /**
         * @var array   Default plugins options
         */
        var $settings;
        ...
        */
        ...
        {
            // TODO : Find better menu place than 'basic"
        ...
        */
        ...
        {
            // TODO : Add providers select list choices
        ...
        */
        function render_field($field)
        {
            ...
            // TODO : We can't add more than only one map per page = set unique ID (here + JS)
            ...
            */
            ...
            <div <?php acf_esc_attr_e( $atts ); ?>>
                ...
                <div class="acf-hidden" id="acf-leaflet-fields-hidden">
                    <?php foreach ($field['value'] as $k => $v):
                        acf_hidden_input( array('name' => $field['name'] . '[' . $k . ']', 'value' => $v, 'class' => 'input-' . $k) );
                    endforeach; ?>
                </div>

                <div id="leaflet-map" style="<?php echo esc_attr( 'height: ' . $field['height'] . 'px' ); ?>"></div>

                <hr>

                <input type="search" id="leaflet-map-input" class="form-control"
